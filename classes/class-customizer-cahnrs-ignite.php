...
class Customizer_CAHNRS_Ignite {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'active_callback' => function() use ( $current_type ) {
					...
					$show = ( in_array( $current_type, $show_with, true ) ) ? true : false;
	...
	private function customize_frontpage( $wp_customize, $panel ) {
		...
		$this->customize_video_banner( $wp_customize, $panel, $section_id, '_cahnrswp_ignite_fronpage_feature', $current_banner );
		...
		$wp_customize->add_control(
			...
			array(
				...
				'active_callback' => function() use ( $wp_customize ) {
					...
					$show = ( in_array( $type, $show_type, true ) && in_array( $source, $show_source, true ) ) ? true : false;
		...
		$wp_customize->add_control(
			...
			array(
				...
				'active_callback' => function() use ( $wp_customize ) {
					...
					return ( in_array( $value, $show_with, true ) && ! empty( $value_add ) ) ? true : false;
